...
namespace DriverCommApp.Conf.DB
{
   ...
   public class DBConfig
   {
      ...
      public enum DBServerType
      {
         ...
         MySQL,
         /// <summary> MySQL Type Database Server: Using a Pool of Threads</summary>
         MySQLPool,
         /// <summary> Fully Complaint Generic SQL Type Database Server</summary>
         SQL,
         /// <summary> Maria DB Type Database Server: NOT IMPLEMENTED</summary>
         Maria,
         /// <summary> Postgre SQL Type Database Server: NOT IMPLEMENTED</summary>
         Postgre,
         /// <summary> Micrsoft SQL Type Database Server: NOT IMPLEMENTED</summary>
         Microsoft
      }
