...
namespace DriverCommApp.Conf
{
   ...
   class ConfMain
   {
      #region Globals Objects for this Class
      /// <summary>
      /// This APP fixed Culture.
      /// Date format is DD/MM/YYYY.
      /// Decimal separator is period ".", and thousands separator is comma ","</summary>
      public System.Globalization.CultureInfo CultProvider = new System.Globalization.CultureInfo("en-GB");
      ...
      private int LoadMainConfig()
      {
         ...
         {
            MainConf.AppDef = int.Parse(appSettings["AppDef"], CultProvider);
            MainConf.RTBaseLoop = int.Parse(appSettings["RTBaseLoop"], CultProvider);
      ...
      private string ReadConfFilePath(string appPath, string filekey)
      {
         try
         {
            string filepath;
